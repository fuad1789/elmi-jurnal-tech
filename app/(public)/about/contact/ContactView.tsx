...
export function ContactView({ settings }: Props) {
  ...
  const email = settings?.contactEmail || 'journal@sdu.edu.az';
  const phone = settings?.contactPhone || '+994 18 242 00 18';
  const address = settings?.address || 'H. Zərdabi küç. 54, Sumqayıt, AZ5008';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200 mt-1">
                {isEn ? 'Get in touch with our editorial team' : 'Redaksiya heyətimizlə əlaqə saxlayın'}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${email}`} className="font-medium text-gray-900 hover:text-academic-blue">
                          {email}
                        </a>
                      </div>
                    </div>
            ...
            <section className="bg-white rounded-lg shadow-md border border-gray-100 p-6">
              ...
              <div className="space-y-2">
                {[
                  { day: { en: 'Monday - Friday', az: 'Bazar ertəsi - Cümə' }, hours: '09:00 - 18:00' },
                  { day: { en: 'Saturday', az: 'Şənbə' }, hours: '10:00 - 14:00' },
                  { day: { en: 'Sunday', az: 'Bazar' }, hours: isEn ? 'Closed' : 'Bağlıdır' },
                ].map((row, i) => (
                  <div key={i} className={`flex justify-between items-center py-3 ${i < 2 ? 'border-b border-gray-100' : ''}`}>
                    <span className="text-gray-700">{isEn ? row.day.en : row.day.az}</span>
            ...
            <section className="bg-gradient-to-r from-academic-blue to-blue-600 text-white rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  { en: 'Submit a Manuscript', az: 'Əlyazma Təqdim Edin', href: `mailto:${email}` },
